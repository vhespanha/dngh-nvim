...
function M.get(spec, config)
  ...
  local groups = {
    ...
    VertSplit    = { fg = c.border.subtle },                                                                    -- the column separating vertically split windows
    WinSeparator = { fg = c.border.subtle },                                                                    -- (nvim >= 0.10) the column separating vertically split windows
    ...
    PmenuThumb   = { bg = spec.bg2},                                                                            -- Popup menu: Thumb of the scrollbar.
    ...
    IncSearch    = inv.search and { style = 'reverse' } or { fg = spec.bg0, bg = c.orange },                -- 'incsearch' highlighting; also used for the text replaced with ':s///c'
