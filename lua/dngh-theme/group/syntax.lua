...
function M.get(spec, config)
  ...
  return {
    ...
    markdownCode = { fg = spec.fg1, style = 'italic' },
    markdownCodeBlock = { link = 'RenderMarkdownCode' },
    markdownH1 = { fg = spec.md.h1, bg = 'NONE', style = 'bold' },
    markdownH2 = { fg = spec.md.h2, bg = 'NONE', style = 'bold' },
    markdownH3 = { fg = spec.md.h3, bg = 'NONE', style = 'bold' },
    markdownH4 = { fg = spec.md.h4, bg = 'NONE', style = 'bold' },
    markdownH5 = { fg = spec.md.h5, bg = 'NONE', style = 'bold' },
    markdownH6 = { fg = spec.md.h6, bg = 'NONE', style = 'bold' },
    ...
    RainbowDelimiterTransparentPink = { fg = spec.rd.transparentPink },
    RainbowDelimiterTransparentBlue = { fg = spec.rd.transparentBlue },
    RainbowDelimiterTransparentViolet = { fg = spec.rd.transparentViolet },

    RainbowDelimiterPink = { fg = spec.rd.pink },
